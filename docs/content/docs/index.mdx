...
<Cards>
  <Card icon={<span />} title="Quickstart" href="/en/docs/quickstart">
    Get running in 5 minutes.
  </Card>
  <Card title="Installation" href="/en/docs/installation">
    Prebuilt binary, source build, or Docker.
  </Card>
  <Card title="Models" href="/en/docs/models">
